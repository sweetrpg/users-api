...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.adminStatsResponse"
                        }
                    },
                    "401": {
        ...
        "/admin/stats/history": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Number of days back to include (default 30, clamped to [1, 90])",
                        "name": "days",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/server.adminStatsHistoryEntry"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.friendsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.pendingRequestsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.sendFriendRequestRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/server.friendRequestResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/internal/resolve-subjects": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Subjects to resolve",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.resolveSubjectsRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "server.friendsResponse": {
            "type": "object",
            "properties": {
                "friends": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.friendEntry"
                    }
                }
            }
        },
        "server.pendingRequestEntry": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "server.pendingRequestsResponse": {
            "type": "object",
            "properties": {
                "incoming": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.pendingRequestEntry"
                    }
                },
                "outgoing": {
                    "type": "array",
        ...
        "server.sendFriendRequestRequest": {
            "type": "object",
            "properties": {
                "identifier": {
                    "description": "Identifier is a User.id, an email, or a username - resolved server-side to the target\nuser (see models.ResolveFriendTarget).",
                    "type": "string"
                }
            }
        },
